class ToDo {
  ...
  editElement() {
    const father = document.getElementById(`${this.id}`);
    ...
    editKeypad.addEventListener('click', () => {
      const title = document.getElementById(`inputTitleEdit${this.id}`);
      const description = document.getElementById(
        `inputDescriptionEdit${this.id}`,
      );
      const date = document.getElementById(`inputDateEdit${this.id}`);
      ...
      const defaultArray = JSON.parse(localStorage.getItem('Default'));
